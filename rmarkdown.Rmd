...
<div align="justify"> <font size="5" face="Times">Este relatório tem o objetivo de analisar os dados da Covid-19 em Minas Gerais. Os dados foram extraídos no dia 13/07/2020 do <a href="http://coronavirus.saude.mg.gov.br/painel">site</a> da Secretaria de Saúde do estado. O escopo da análise foi comparar a contaminação e evolução do novo coronavírus segundo a faixa-etária, comorbidade, gênero e região do estado. Quanto à região, optou-se por comparar as macro regiões do norte de Minas com a região metropolitana. </div>
...
<div align="justify"><font size="5" face="Times"> Para responder à pergunta proposta foram elaborados três gráficos, que abordam a evolução dos casos, aqueles nos quais foi necessária a internação e aqueles nos quais foi necessária a internação em Unidades de Tratamento Intensivo (UTI), todos considerando o recorte de se o paciente havia alguma comorbidade prévia. Para fins dessa análise foram excluídos os casos em que não há informação sobre comorbidade ou sobre a evolução clínica do caso, uma vez que considerá-los não agregaria informação à analíse proposta. Abaixo têm-se os gráficos e uma breve explicação acerca de seu comportamento.
...
<div align="justify"><font size="5" face="Times"> O gráfico acima corrobora com as inferências anteriormente feitas, uma vez que o grupo de indivíduos que possui comorbidade tiveram porcentagem mais expressiva de necessidade de internação em UTI. Dessa forma, conclui-se que a existência de comorbiade é um fator que permite inferir acerca da evolução da Covid-19.
...
<div align="justify"><font size="5" face="Times">Outo ponto a destacar é o expressivo número de casos em que não há informação sobre a evolução dos casos. Isso prejudica a análise da questão levantada.</div>
...
<br/> 
<div align="justify"><font size="5" face="Times">Já em relação às variáveis “Recuperado”, “Não Informado” e “Em acompanhamento” segundo a evolução não há uma relação clara definida observada no gráfico. Mais uma vez, o elevado número de casos não informado prejudica a análise dessa questão.</div>
...
<br/> 
 ...
 <br/> 
 <div align="justify"> <font size="5" face="Times">Em relaçao aos outros critérios escolhidos (gênero e região), entende-se que análise ficou prejudicada pelo elevado número de ausência de informação. Isso revela a necessidade de melhoria no processo de coleta dos dados pela Secretaria de Saúde. </div>
